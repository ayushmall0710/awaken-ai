...
awakenai run CON008 -p oddball --electrodes Pz,Cz # Run oddball ERP with selected electrodes
...
- Integrate richer visual representations (Event Related Potentials, topomaps) and summary tables directly into a CLI reporting tool once the Language pipeline ([PR #44](https://github.com/ayushmall0710/awaken-ai/pull/44)) is merged into main.
