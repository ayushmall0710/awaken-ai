...
- **Filter**: 0.02 - 25.0 Hz (0.02 Hz high-pass provides a safety margin below the sentence band; 25.0 Hz low-pass avoids high-frequency aliasing before downsampling).
- **Montage**: Standard 10-20.
- **Channels**: Left Hemisphere Focus (6 channels: Fp1, F7, T7, F3, C3, P3) is default, with explicit validation of focus parameter (`LH`, `RH`, or `Clinical`).
